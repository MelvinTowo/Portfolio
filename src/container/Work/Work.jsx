...
const Work = () => {
  ...
  const [activeFilter, setActiveFilter] = useState('All') // The menus on top of the work section ' default set to all option'
  ...
  return (
    <>
      ...
      <div className="app__work-filter">
        {['UI/UX', 'WebApp', 'MobileApp', 'Script', 'All'].map((item, index) => (
          <div
            key={index}
